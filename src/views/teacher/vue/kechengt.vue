<template>
  <div>
    ...
    <el-dialog
      ...
      width="50%"
      @close="closeDialogForm('kechengform')"
    >
      <el-form
        :model="kechengform"
        :rules="rules"
      ...
      >
        ...
        >
          <el-input
            v-model="kechengform.Introduction"
            maxlength="64"
            :disabled="isView"
            suffix-icon="el-icon-edit"
            placeholder="简介为空填0"
        ...
        >
          <el-input
            v-model="kechengform.ID_Location"
            :disabled="isView"
            suffix-icon="el-icon-edit"
          ></el-input>
        </el-form-item>
        ...
        >
          <el-input
            v-model="kechengform.ID_Speaker"
            :disabled="isView"
            suffix-icon="el-icon-edit"
          ></el-input>
        </el-form-item>
        ...
        >
          <el-input
            v-model="kechengform.TimeBeginCheckBegin"
            :disabled="isView"
            suffix-icon="el-icon-edit"
          ></el-input>
        </el-form-item>
        ...
        >
          <el-input
            v-model="kechengform.TimeBeginCheckEnd"
            :disabled="isView"
            suffix-icon="el-icon-edit"
          ></el-input>
        </el-form-item>
        ...
        >
          <el-input
            v-model="kechengform.TimeEndCheckBegin"
            :disabled="isView"
            suffix-icon="el-icon-edit"
          ></el-input>
        </el-form-item>
        ...
        >
          <el-input
            v-model="kechengform.TimeEndCheckEnd"
            :disabled="isView"
            suffix-icon="el-icon-edit"
          ></el-input>
        </el-form-item>
        ...
        >
          <el-input
            v-model="kechengform.RangeUsers"
            maxlength="1024"
            :disabled="isView"
            suffix-icon="el-icon-edit"
        ...
        >
          <el-input
            v-model="kechengform.ListPlaces"
            maxlength="1024"
            :disabled="isView"
            suffix-icon="el-icon-edit"
        ...
        >
          <el-input
            v-model="kechengform.MapUser2Equ"
            maxlength="1024"
            :disabled="isView"
            suffix-icon="el-icon-edit"
        ...
        >
          <el-input
            v-model="kechengform.AboutSpeaker"
            maxlength="1024"
            :disabled="isView"
            suffix-icon="el-icon-edit"
        ...
        >
          <el-input
            v-model="kechengform.ID_Speaker_NoUser"
            :disabled="isView"
            suffix-icon="el-icon-edit"
            placeholder="职工号为空填0"
          ></el-input>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          ...
          size="mini"
          v-show="!isView"
          @click="submitkechengform('kechengform')"
          >确定</el-button
        >
        <el-button
          type="info"
          size="mini"
          @click="closeDialogForm('kechengform')"
          >取消</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    submitaddkecheng() {
      ...
      this.addkechengform.data[0].ID_Curricula =
        this.kechengform.ID_Curricula * 1;
      this.addkechengform.data[0].ID_Location =
        this.kechengform.ID_Location * 1;
      this.addkechengform.data[0].ID_Speaker = this.kechengform.ID_Speaker * 1;
      this.addkechengform.data[0].TimeBegin = timechange1(
        this.kechengform.TimeBegin
      );
      this.addkechengform.data[0].TimeEnd = timechange1(
        this.kechengform.TimeEnd
      );
      ...
      //执行Axios请求
      axios
        .post("/api/" + "model_courseplan/", that.addkechengform)
        .then(res => {
          //执行成功
          if (true) {
            //res.data.code == 1
    ...
    submitupdatakecheng() {
      ...
      //执行Axios请求
      axios
        .put("/api/" + "model_courseplan/", that.updatekechengform)
        .then(res => {
          //执行成功
          if (true) {
            //res.data.code == 1
    ...
    deletekechengs() {
      ...
      this.$confirm(
        ...
        .then(() => {
          ...
          //调用后端接口
          axios
            .delete(this.baseURL + "model_courseplan/", {
              data: [
                {
                  ids: ids
                }

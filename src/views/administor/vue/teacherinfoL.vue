  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item
          label="描述"
          prop="userex_related_to_user_information__rem"
          v-if="adddialog || viewdialog || updatedialog || deletedialog"
        >
          <el-input
            v-model="userform.userex_related_to_user_information__rem"
            :disabled="isView"
            suffix-icon="el-icon-edit"
          ></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitupdatauser() {
      ...
      //执行Axios请求
      axios
        .patch("/api/" + "TeachersInformation/", that.userform)
        .then(res => {
          //执行成功
          if (true) {
            //res.data.code == 1
    ...
    deleteuser(row) {
      ...
      this.$confirm(
        ...
        .then(() => {
          ...
          //调用后端接口
          axios
            .delete("/api/" + "TeachersInformation/", {

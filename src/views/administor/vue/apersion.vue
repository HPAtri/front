               ...
               <table >
                   ...
                   <tr>
                        ...
                        <td><el-form-item prop="Rem" >
                            <el-input prefix-icon='iconfont icon-edit' v-model="userform.Rem" :disabled="false"    auto-complete="on"></el-input>
                        </el-form-item></td>
                   </tr>
                   <tr>
                        <td>简介:</td>
                        <td><el-form-item prop="Introduction" >
                            <el-input prefix-icon='iconfont icon-edit' v-model="userform.Introduction" :disabled="false"    auto-complete="on"></el-input>
                        </el-form-item></td>
                   </tr>
                   <tr>
                        <td>更新时间</td>
                   ...
                   <tr>
                        ...
                        <td><el-form-item prop="Psw" >
                            <el-input prefix-icon='iconfont icon-edit' v-model="userform.Psw" :disabled="false"    auto-complete="on"></el-input>
                        </el-form-item></td>
                   </tr>
                   <tr>
                        <td>性别:</td>
                ...
                <el-select v-model="userform.PowerJf" :disabled="isView" placeholder="请选择">
                    ...
                    <tr>
                        ...
                        <td><el-form-item prop="Email" >
                            <el-input prefix-icon='iconfont icon-edit' v-model="userform.Email" :disabled="false"    auto-complete="on"></el-input>
                        </el-form-item></td>
                   </tr>
                   <tr>
                        <td>手机号码:</td>
                        <td><el-form-item prop="Phone" >
                            <el-input prefix-icon='iconfont icon-edit' v-model="userform.Phone" :disabled="false"    auto-complete="on"></el-input>
                        </el-form-item></td>
                   </tr>
                    <tr>
                        <td>用户余额1:</td>
